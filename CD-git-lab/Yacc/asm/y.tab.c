...
{
  "$end", "error", "$undefined", "ALPHA", "INTEGER", "'-'", "'+'", "'*'",
  "'/'", "'='", "';'", "'('", "')'", "$accept", "statement_set",
  "expression", 0
};
#endif
  ...
  switch (yyn)
    {
        case 2:
#line 37 "asm_sym.y"
    {appendToTable((char)(yyvsp[(1) - (4)].sym),(char)(yyvsp[(3) - (4)].sym),'=');}
    break;
...
#line 38 "asm_sym.y"
  ...
  case 4:
#line 42 "asm_sym.y"
    {(yyval.sym) = appendToTable((char)(yyvsp[(1) - (3)].sym),(char)(yyvsp[(3) - (3)].sym),'+');}
    break;
